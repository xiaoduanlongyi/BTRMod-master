...
public class IntangibleBocchi extends BaseRelic implements OnReceivePowerRelic {
    private static final String NAME = "IntangibleBocchi"; //The name will be used for determining the image file as well as the ID.
