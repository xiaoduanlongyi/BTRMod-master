...
import static btrmod.BTRMod.characterPath;
...
public class KessokuBandChar extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("KessokuBand"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass KessokuBand;
        ...
        private static final Color cardColor = new Color(1f, 0.6f, 0.8f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new KessokuBandChar(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(StrikeKita.ID);
        retVal.add(StrikeNijika.ID);
        retVal.add(StrikeBocchi.ID);
        retVal.add(StrikeRyo.ID);
        retVal.add(Ensemble.ID);
        retVal.add(MatureMango.ID);
        retVal.add(MatureMango.ID);
        retVal.add(MatureMango.ID);
        retVal.add(MatureMango.ID);
        retVal.add(ProudBocchi.ID);
